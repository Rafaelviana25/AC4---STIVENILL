            ...
            return (
              <button 
                ...
                className={`
                  ...
                  ${!dayObj.currentMonth ? 'bg-slate-800 text-slate-600' : 
                    (i % 7 === 0 || i % 7 === 6 ? 'bg-[#ccff00]/20 text-black' : 'bg-[#0f172a]')
                  }
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between w-full p-0.5">
                  ...
                  {holidayName && (
                    <div className={`w-full text-[6px] font-black uppercase px-0.5 leading-[1.1] text-center mt-auto pb-0.5 relative z-30 ${shifts.length > 0 ? 'text-white drop-shadow-md' : (i % 7 === 0 || i % 7 === 6) ? 'text-black' : 'text-yellow-500'}`}>
                      {holidayName}
                    </div>
                  )}
                </div>
